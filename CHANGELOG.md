...
- Spec + Phase 1 sealed implementation for native **`.orchid`** container
  (`crates/orchid-format`: ORCD/ORCR framing, FlatBuffers TOC, zstd Clean-Text /
  Structured, `memmap2` open, `orchid-format` CLI create/read) — see
