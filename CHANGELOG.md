...
- Spec + Phase 1–2 for native **`.orchid`** container (`crates/orchid-format`:
  ...
  repack, Version-history stub, `orchid-format` CLI create/read with
  `--passphrase`) — see [`docs/ORCHID_FORMAT.md`](docs/ORCHID_FORMAT.md).
