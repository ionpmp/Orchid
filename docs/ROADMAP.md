...
- [x] File properties / content metadata — Alt+Enter report (path, times, attributes, MIME) plus EXIF, ID3, Office `docProps/core.xml` edit, Authenticode / PE certificate-table view, and Sharing (SMB name / UNC, share or unshare folder, open the Windows Sharing tab)
- [x] Quick filter
