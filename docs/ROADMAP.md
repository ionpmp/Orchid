...
- [x] Tabs, breadcrumbs
- [~] Drag-and-drop — folder rows, breadcrumbs, cross-pane, OS drop (move/copy with Ctrl), FM→viewer content zone, cross-widget FM move, transfer progress bar; canvas + FM content-zone hit-test
