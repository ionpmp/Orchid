...
jyotish-profile-date-placeholder = تاريخ الولادة (YYYY-MM-DD)
jyotish-profile-time-placeholder = وقت الولادة (HH:MM)
jyotish-profile-offset-placeholder = إزاحة UTC (دقائق)
