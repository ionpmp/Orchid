...
jyotish-profile-date-placeholder = Дата рождения (YYYY-MM-DD)
jyotish-profile-time-placeholder = Время рождения (HH:MM)
jyotish-profile-offset-placeholder = UTC-смещение (минуты)
