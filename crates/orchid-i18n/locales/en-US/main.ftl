...
processes-svc-state-stopped = Stopped
processes-svc-state-start-pending = Start pending
processes-svc-state-stop-pending = Stop pending
processes-svc-state-running = Running
processes-svc-state-continue-pending = Continue pending
processes-svc-state-pause-pending = Pause pending
processes-svc-state-paused = Paused
processes-svc-state-unknown = Unknown ({ $code })
processes-svc-start-boot = Boot
processes-svc-start-system = System
processes-svc-start-auto = Automatic
processes-svc-start-manual = Manual
processes-svc-start-disabled = Disabled
processes-svc-start-other = Other ({ $code })
processes-session-active = Active
processes-session-connected = Connected
processes-session-connect-query = Connect query
processes-session-shadow = Shadow
processes-session-disconnected = Disconnected
processes-session-idle = Idle
processes-session-listen = Listen
processes-session-reset = Reset
processes-session-down = Down
processes-session-init = Init
processes-session-unknown = Unknown ({ $code })
processes-startup-user-folder = Startup folder
processes-startup-common-folder = Common Startup
...
browser-bookmark-remove = Remove bookmark
browser-find = Find
...
jyotish-today = Today
jyotish-search-today-title = Jyotish · Today
jyotish-search-today-sub = Panchanga for today
jyotish-search-generic-sub = Vedic panchanga
...
audio-player-unknown-artist = Unknown Artist
audio-player-unknown-album = Unknown Album
audio-player-sleep-minutes = Sleep { $minutes }m
audio-player-sleep-countdown = Sleep { $minutes }m{ $seconds }s
audio-player-sleep-seconds = Sleep { $seconds }s
...
viewer-pdf-outline = Outline
viewer-pdf-find = Find
viewer-pdf-find-placeholder = Find in PDF…
viewer-pdf-find-no-match = No matches
viewer-pdf-print = Print
viewer-pdf-highlight = Highlight
viewer-pdf-comment = Comment
viewer-pdf-printed = Sent to printer
viewer-pdf-highlighted = Saved { $path }
...
viewer-media-prev = Prev
viewer-media-next = Next
...
viewer-html-hint = Embedded preview. Open in the system browser for a separate window.
viewer-html-source = Source
viewer-html-back = Back
viewer-html-forward = Forward
viewer-html-reload = Reload
viewer-html-unavailable = WebView2 Runtime is not installed; showing source. Open in the system browser to view the page.
viewer-document-info = Document · { $words } words · { $chars } characters · { $comments } comments · { $blocks } blocks · { $warnings } unsupported features
...
viewer-document-comment-placeholder = Comment text…
viewer-document-comment-apply = Apply
...
viewer-document-header-placeholder = Header text
viewer-document-footer-placeholder = Footer text
...
viewer-document-tip-comment = Insert comment on selection
viewer-document-tip-comment-delete = Delete comment at caret
viewer-document-tip-comment-edit = Edit comment at caret
viewer-document-tip-comment-next = Next comment
viewer-document-tip-comment-prev = Previous comment
viewer-document-tip-header = Edit default page header
viewer-document-tip-footer = Edit default page footer
viewer-document-tip-header-first = Edit first-page header
viewer-document-tip-footer-first = Edit first-page footer
viewer-document-tip-header-even = Edit even-page header
viewer-document-tip-footer-even = Edit even-page footer
viewer-document-tip-page-field = Insert page number (PAGE / NUMPAGES) in footer
viewer-document-tip-section-break = Insert next-page section break (again on Sec end: cycle continuous)
viewer-document-tip-date-field = Insert DATE field
viewer-document-tip-filename-field = Insert FILENAME field
...
viewer-document-tip-character-style = Cycle character style (w:rStyle)
...
viewer-document-tip-title-page = Different first page (title page)
viewer-document-tip-even-and-odd-headers = Different odd and even pages
...
jyotish-profile-default-name = Profile
