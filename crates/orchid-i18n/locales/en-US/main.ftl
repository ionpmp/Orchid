...
jyotish-profile-date-placeholder = Birth date (YYYY-MM-DD)
jyotish-profile-time-placeholder = Birth time (HH:MM)
jyotish-profile-offset-placeholder = UTC offset (minutes)
