...
jyotish-influence-calm = 강한 영향은 없습니다. 하루는 고르게 흐른다
jyotish-influence-tara-janma = Janma tara: 감성 고조, 바디케어
jyotish-influence-tara-sampat = Sampat tara : 부와 이득이 지원됩니다
jyotish-influence-tara-vipat = Vipat tara: 장애물이 있을 수 있음, 위험을 피함
jyotish-influence-tara-kshema = Kshema tara: 보호와 웰빙
jyotish-influence-tara-pratyak = Pratyak tara: 계획 저항, 출시 연기
jyotish-influence-tara-sadhana = Sadhana tara: 집중적인 노력이 성공합니다
jyotish-influence-tara-naidhana = Naidhana tara: 지치는 날, 에너지 절약
jyotish-influence-tara-mitra = Mitra tara: 동맹과 우호적 지원
jyotish-influence-tara-parama-mitra = Parama Mitra tara: 전반적으로 뛰어난 지원
jyotish-influence-chandra-high = 달은 강한 집에서 당신을 지원합니다
jyotish-influence-chandra-neutral = 오늘 달은 중립이다
jyotish-influence-chandra-low = 달이 낮은 집을 통과합니다: 기분과 활력 저하
jyotish-influence-tithi-rikta = Rikta tithi: 새로운 시작을 위한 공허한 날
jyotish-influence-tithi-purna = Purna tithi: 완성과 충만을 선호합니다.
jyotish-influence-tithi-flow = 음력의 날은 꾸준한 발전을 지원합니다
jyotish-influence-amavasya = 초승달: 내면으로 향하고, 휴식하고, 반성하세요
jyotish-influence-purnima = 보름달: 감정과 결과가 최고조에 달함
jyotish-influence-yoga-vyatipata = Vyatipata yoga : 갑작스러운 반전 가능
jyotish-influence-yoga-vaidhriti = Vaidhriti yoga: 마찰과 지연
jyotish-influence-yoga-tense = 긴장감 넘치는 yoga가 하루를 지배한다
jyotish-influence-vishti = Vishti karana: 중요한 일은 시작하지 마세요.
jyotish-influence-karana-fixed = 고정된 karana: 참신한 것보다 일상적인 것에 더 좋습니다.
jyotish-advice-avoid-big = 오늘은 대규모 출시, 계약, 대규모 구매를 피하세요.
jyotish-advice-routine = 루틴을 고수하세요. 더 나은 날로 위험을 미루다
jyotish-advice-act = 시작하고, 서명하고, 앞으로 나아갈 수 있는 좋은 날입니다.
jyotish-advice-flow = 흐름을 따르십시오. 꾸준한 노력이 결실을 맺는다
...
jyotish-birth-prompt = 개인 예측 및 인생 회고를 잠금 해제하려면 설정에 출생 데이터를 입력하세요.
...
jyotish-advice-mode-personal = 조언은 당신의 탄생 달에 맞춰져 있습니다
jyotish-advice-personal-advance = 귀하의 차트는 오늘의 결정적인 움직임을 뒷받침합니다
jyotish-advice-personal-caution = 출생 계층에서 측정된 걸음 수를 요청합니다.
jyotish-advice-personal-rest = 에너지를 절약하세요. 오늘 네 출생지표가 무거워
...
jyotish-gochara-challenging = 트랜짓: Shani/Rahu 나탈 문에 대한 압박
jyotish-gochara-favorable = 트랜짓: 나탈 문을 지지하는 Guru
jyotish-influence-layer-panchanga = Panchanga 레이어: 음력 일, yoga 및 karana에만 해당
jyotish-influence-layer-personal = 개인 레이어: 출생 차트의 tara 및 문 하우스
jyotish-influence-paksha-krishna = 약 2주: 완성 및 출시
jyotish-influence-paksha-shukla = 왁싱 2주: 성장과 외적인 노력
jyotish-influence-vara-jupiter = 목요일 현재: 지혜와 확장
jyotish-influence-vara-mars = 화요일 현재: 추진 및 충돌 위험
jyotish-influence-vara-mercury = 수요일 현재: 커뮤니케이션과 무역
jyotish-influence-vara-moon = 월요일 현재 : 기분과 관리
jyotish-influence-vara-saturn = 토요일 현재: 징계 및 지연
jyotish-influence-vara-sun = 일요일 현재: 권위와 명확성
jyotish-influence-vara-venus = 금요일 현재: 조화와 즐거움
