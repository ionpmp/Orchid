...
fn empty_viewer_image_model(locale: &LocaleManager) -> ViewerImageModel {
    ViewerImageModel {
        ...
        more_label: locale.tr("viewer-image-more").into(),
...
fn empty_viewer_media_model(locale: &LocaleManager) -> ViewerMediaModel {
    ViewerMediaModel {
        ...
        replaygain_label: SharedString::new(),
        hwdec_label: SharedString::new(),
        sleep_label: SharedString::new(),
        aspect_label: SharedString::new(),
        rotate_label: SharedString::new(),
        audio_delay_label: SharedString::new(),
        osd_text: SharedString::new(),
...
fn build_media_snapshot(
    ...
    ViewerMediaModel {
        ...
        replaygain_label: s.replaygain_label.clone().into(),
        hwdec_label: s.hwdec_label.clone().into(),
        sleep_label: s.sleep_label.clone().into(),
        aspect_label: s.aspect_label.clone().into(),
        rotate_label: s.rotate_label.clone().into(),
        audio_delay_label: s.audio_delay_label.clone().into(),
        osd_text: s.osd_text.clone().into(),
...
fn empty_viewer_document_model(locale: &LocaleManager) -> ViewerDocumentModel {
    ViewerDocumentModel {
        ...
        save_as_label: locale.tr("viewer-document-save-as").into(),
        ...
        comment_next_label: locale.tr("viewer-document-comment-next").into(),
        comment_prev_label: locale.tr("viewer-document-comment-prev").into(),
        ...
        tip_comment_next: locale.tr("viewer-document-tip-comment-next").into(),
        tip_comment_prev: locale.tr("viewer-document-tip-comment-prev").into(),
        ...
        tip_page_field: locale.tr("viewer-document-tip-page-field").into(),
        tip_section_break: locale.tr("viewer-document-tip-section-break").into(),
        tip_date_field: locale.tr("viewer-document-tip-date-field").into(),
        tip_filename_field: locale.tr("viewer-document-tip-filename-field").into(),
        ...
        tip_color_green: locale.tr("viewer-document-tip-color-green").into(),
        tip_superscript: locale.tr("viewer-document-tip-superscript").into(),
        tip_subscript: locale.tr("viewer-document-tip-subscript").into(),
        tip_clear_formatting: locale.tr("viewer-document-tip-clear-formatting").into(),
        tip_align_left: locale.tr("viewer-document-tip-align-left").into(),
        tip_align_center: locale.tr("viewer-document-tip-align-center").into(),
        tip_align_right: locale.tr("viewer-document-tip-align-right").into(),
        tip_align_justify: locale.tr("viewer-document-tip-align-justify").into(),
        tip_list_bullet: locale.tr("viewer-document-tip-list-bullet").into(),
        tip_list_numbered: locale.tr("viewer-document-tip-list-numbered").into(),
        tip_image_insert: locale.tr("viewer-document-tip-image-insert").into(),
        tip_table_insert: locale.tr("viewer-document-tip-table-insert").into(),
        tip_table_row_insert: locale.tr("viewer-document-tip-table-row-insert").into(),
        tip_table_row_delete: locale.tr("viewer-document-tip-table-row-delete").into(),
        tip_table_col_insert: locale.tr("viewer-document-tip-table-col-insert").into(),
        tip_table_col_delete: locale.tr("viewer-document-tip-table-col-delete").into(),
        tip_table_merge: locale.tr("viewer-document-tip-table-merge").into(),
        tip_table_unmerge: locale.tr("viewer-document-tip-table-unmerge").into(),
        tip_font_smaller: locale.tr("viewer-document-tip-font-smaller").into(),
        tip_font_larger: locale.tr("viewer-document-tip-font-larger").into(),
        ...
        tip_save_as: locale.tr("viewer-document-tip-save-as").into(),
        ...
        header_distance_less_label: locale.tr("viewer-document-header-distance-less").into(),
        header_distance_more_label: locale.tr("viewer-document-header-distance-more").into(),
        footer_distance_less_label: locale.tr("viewer-document-footer-distance-less").into(),
        footer_distance_more_label: locale.tr("viewer-document-footer-distance-more").into(),
        indent_less_label: locale.tr("viewer-document-indent-less").into(),
        indent_more_label: locale.tr("viewer-document-indent-more").into(),
        indent_right_less_label: locale.tr("viewer-document-indent-right-less").into(),
        indent_right_more_label: locale.tr("viewer-document-indent-right-more").into(),
        ...
        tip_space_before_less: locale.tr("viewer-document-tip-space-before-less").into(),
        tip_space_before_more: locale.tr("viewer-document-tip-space-before-more").into(),
        tip_space_after_less: locale.tr("viewer-document-tip-space-after-less").into(),
        tip_space_after_more: locale.tr("viewer-document-tip-space-after-more").into(),
        tip_line_spacing_less: locale.tr("viewer-document-tip-line-spacing-less").into(),
        tip_line_spacing_more: locale.tr("viewer-document-tip-line-spacing-more").into(),
        tip_margin_less: locale.tr("viewer-document-tip-margin-less").into(),
        tip_margin_more: locale.tr("viewer-document-tip-margin-more").into(),
        tip_header_distance_less: locale.tr("viewer-document-tip-header-distance-less").into(),
        tip_header_distance_more: locale.tr("viewer-document-tip-header-distance-more").into(),
        tip_footer_distance_less: locale.tr("viewer-document-tip-footer-distance-less").into(),
        tip_footer_distance_more: locale.tr("viewer-document-tip-footer-distance-more").into(),
        tip_indent_less: locale.tr("viewer-document-tip-indent-less").into(),
        tip_indent_more: locale.tr("viewer-document-tip-indent-more").into(),
        tip_indent_right_less: locale.tr("viewer-document-tip-indent-right-less").into(),
        tip_indent_right_more: locale.tr("viewer-document-tip-indent-right-more").into(),
